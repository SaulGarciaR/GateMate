...
synth_aesuart: $(VLOG_SRC)
	$(YOSYS) -ql log/synth.log -p 'ghdl --warn-no-binding -C --ieee=synopsys src/serial_tx.vhd -e serial_tx; ghdl --warn-no-binding -C --ieee=synopsys src/serial_rx.vhd -e serial_rx; read -sv $^; synth_gatemate -top $(TOP) -nomx8 -vlog net/$(TOP)_synth.v'
